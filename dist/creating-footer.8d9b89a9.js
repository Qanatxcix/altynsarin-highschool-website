...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/creating-footer.js":[function(require,module,exports) {
"use strict";
...
var creatingFooter = footer.creating;

function setClass(thisElement, classes) {
  for (var indx = 0; indx < classes.length; indx++) {
    thisElement.classList.add("".concat(classes[indx]));
  }
}

setClass(creatingFooter, footer.class);
var inFooterContainer = footer.container.main;
...
var backToTop = footer.content.backToTop.creating;
backToTop.href = "#";
...
paragraphs.first.classList.add(footer.content.paragraph.specificCLasses.mbOne); // paragraphs.second.textContent = 'Дипломдық жобаның атауы: ';
...
var selectedMainContainer = document.querySelector('.container.is-main');
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/creating-footer.js"], null)
//# sourceMappingURL=/creating-footer.8d9b89a9.js.map